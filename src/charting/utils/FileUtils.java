...
public class FileUtils {
    ...
    private static const LOG = "MPChart-FileUtils";
     ...
     * @return
     */
    public static List<Entry> loadEntriesFromFile(let path) {
     ...
     * @return
     */
    public static List<Entry> loadEntriesFromAssets(AssetManager am, let path) {
     ...
     * @param path
     */
    public static void saveToSdCard(List<Entry> entries, let path) {
    ...
    public static List<BarEntry> loadBarEntriesFromAssets(AssetManager am, let path) {
